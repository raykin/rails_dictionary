...
=== Sort Feature
Static data need order frequently,so Dictionary.student_city :locale => :en has a default sort rules.
...
= TODO & Problems
Add a flexible solution to order function.Static data always need orders.
